...
let quantidadeDeEstudantes = 0
let somaDasNotas = 0
for (aluno of curso.estudantes){
    quantidadeDeEstudantes ++
    somaDasNotas = somaDasNotas + aluno.progresso

    let situacao = aluno.progresso> 70 ? "Aprovado" : "Em andamento"
    console.log(`Estudante: ${aluno.nome} | Progresso: ${aluno.progresso}% | Situação: ${situacao}`)
}
console.log("")
console.log(`Total de estudantes: ${quantidadeDeEstudantes}`)
console.log(`Média da turma: ${somaDasNotas/quantidadeDeEstudantes}%`)