...
function responderUsuario (nomeDeUsuário,mensagem){
    console.log("Processando sua pergunta...")
    setTimeout((mensagem)=>{console.log( "Olá", nomeDeUsuário,"aqui está a resposta para a sua duvida")},3000)
}
responderUsuario("ana")